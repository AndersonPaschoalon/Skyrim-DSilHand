Scriptname DSilHand_GallowsRockEntranceTrigger extends ObjectReference  
{Activated when the player goes near of Driftshade Refugee.}
...
Actor Property GallowsGuard  Auto  
{Gallows Rock guard.}

String THIS_FILE = "(DSilHand_GallowsRockEntranceTrigger.pcs)  "
...
Function firstMetConversation()
    ...
    GallowsGuard.DrawWeapon(); https://www.creationkit.com/index.php?title=ForceGreet_(Procedure) 
