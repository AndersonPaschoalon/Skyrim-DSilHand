...
Scriptname DSilHand_A01_QF_Troubleshoot Extends Quest Hidden
...
;BEGIN CODE
; Fix for a bug caused by conflict with another mods.
; Force the essential Silver Hands to be disabled -- required if the player joined the Companions
Debug.TraceAndBox(THIS_FILE + " -- Force disable Essential Silver Hand Actors. Only execute this if you are a Companion!", 1)
DSilHand_M10Helper m10Helper = DSilHand_M10SilverHunt as DSilHand_M10Helper
m10Helper.disableSilverhandUniqueActors()
;END CODE
EndFunction
;END FRAGMENT
...
{Version of this mod. Format: vX.Y.Z (X-Release Version, Y-Bugfix, Z-Commit Number)}
