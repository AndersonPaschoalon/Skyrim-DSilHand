...
;BEGIN CODE
;
; -- Plugin Dawn of the Silver Hands integration --
;
Debug.Trace("(C00)(DSilHand_M10) -- Quest Take Up Arms FAILED!")
;END CODE
EndFunction
;END FRAGMENT
...
; -- Plugin Dawn of the Silver Hands integration --
;
Debug.Trace("(C00)(DSilHand_M10) --  Player joined the Companions: trigger Stage 100 of the quest DSilHand_M10...")
DSilHand_M10SilverHunt.SetStage(100)
;END CODE
EndFunction
;END FRAGMENT
