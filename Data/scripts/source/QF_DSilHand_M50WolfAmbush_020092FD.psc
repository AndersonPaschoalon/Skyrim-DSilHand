...
Debug.Trace("-- M50 Objective 20 completed")

; Teleport the companions rokies to Gallows entrance
Debug.Trace("-- M50 preM60: teleport the companions rookies to Gallows Rock entrace")
...
Debug.Trace("--  Check preM60 actors")
Debug.Trace("--  bret1:<" + bret1 + ">")
Debug.Trace("--  imp1:<" +  imp1 + ">")
Debug.Trace("--  markB1:<" +  markB1 + ">")
Debug.Trace("--  markI1:<" + markI1+ ">")
...
Debug.Trace("-- Starts DSilHand_M50WolfAmbush Quest ")
;END CODE
EndFunction
;END FRAGMENT
