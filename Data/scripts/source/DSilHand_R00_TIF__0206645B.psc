...
Scriptname DSilHand_R00_TIF__0206645B Extends TopicInfo Hidden

;BEGIN FRAGMENT Fragment_0
Function Fragment_0(ObjectReference akSpeakerRef)
Actor akSpeaker = akSpeakerRef as Actor
;BEGIN CODE
Debug.Trace(THIS_FILE + "-- runs startsRadiantQuest(): Hillara, Group")
...
r00Helper.startsRadiantQuest(70, 1)
;END CODE
EndFunction
;END FRAGMENT
