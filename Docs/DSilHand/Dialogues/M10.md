...
* DSilHand_M10GMK_Topic05
    ...
    Krev the Skinner: I will give you one book too, it is called Song Of Return, volume seven. 

    Krev the Skinner: Read it, you will learn more about the Ysgramour and its legacy. 

    Krev the Skinner: Each Silver Hand must read one of this. 

    Krev the Skinner: Downsteirs, there is a library, where you will find other usefull book, if you are interested to learn more. 
