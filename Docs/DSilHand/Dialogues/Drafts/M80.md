...
> _Quick scene, where Fjol call all the Silver Hands, before starting the main scene, wich is slower to run, since it is much havier._

* DSilHand_M80SAC_Topic01

    Fjol: Brothers, put down your weapons!! 
