...
r05.createAlarmRowbackQuest(1, 3, true)
;END CODE
EndFunction
;END FRAGMENT
...
; Add map marker
ClearsprintCaveMarker.AddToMap()
;END CODE
EndFunction
;END FRAGMENT
...
; add map marker
CragwallowSlopeMarker.AddToMap()
;END CODE
EndFunction
;END FRAGMENT
...
ObjectReference Property ClearsprintCaveMarker  Auto  

ObjectReference Property CragwallowSlopeMarker  Auto  

ObjectReference Property DarklightTowerMarker  Auto  
