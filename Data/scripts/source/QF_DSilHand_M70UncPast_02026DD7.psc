...
Scriptname QF_DSilHand_M70UncPast_02026DD7 Extends Quest Hidden
...
Function Fragment_0()
;BEGIN CODE
Debug.Trace("(DSilHand_M70) -- START STAGE")
;END CODE
EndFunction
;END FRAGMENT
...
;END AUTOCAST
;BEGIN CODE
Debug.Trace("(DSilHand_M70) -- kmyQuest.moveKrevToSovngarde()")
kmyQuest.moveKrevToSovngarde()

Debug.Trace("(DSilHand_M70) -- kmyQuest.enableKrevGrave()  ")
kmyQuest.enableKrevGrave()  

Debug.Trace("(DSilHand_M70) -- kmyQuest.enableSilverhandGraves()")
kmyQuest.enableSilverhandGraves()

Debug.Trace("(DSilHand_M70) -- kmyQuest.setFjolOnGrave()")
kmyQuest.setFjolOnGrave()
;END CODE
EndFunction
;END FRAGMENT
...
Function Fragment_5()
;BEGIN CODE
Debug.Trace("(DSilHand_M70) -- Fjol sends you to search for the fragment")
;END CODE
EndFunction
;END FRAGMENT
