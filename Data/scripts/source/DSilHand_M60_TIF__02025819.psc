...
Debug.Trace("(DSilHand M60) -- Dragonborn finishes the talk with Senaar")

; Update Quest Objective/Stage
Debug.Trace("(DSilHand M60) -- Objective Completed 30")
GetOwningQuest().SetObjectiveCompleted(30);
Debug.Trace("(DSilHand M60) -- ObjectiveDisplayed 40")
GetOwningQuest().SetObjectiveDisplayed(40)
Debug.Trace("(DSilHand M60) -- Stage 40")
