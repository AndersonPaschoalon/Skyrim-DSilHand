...
;END AUTOCAST
;BEGIN CODE
Debug.Trace("(DSilHand_M70) -- Intermediate state: prepare kkrev fineral, and advances imediatelly")

; prepare krev funeral
Debug.Trace("(DSilHand_M70) -- kmyQuest.prepareSilverHandFuneral()")
...
;END AUTOCAST
;BEGIN CODE
Debug.Trace("(DSilHand_M70) -- Stage 20")
;END CODE
EndFunction
;END FRAGMENT
...
;END AUTOCAST
;BEGIN CODE
Debug.Trace("(DSilHand_M70) -- kmyQuest.cleanScript()")
kmyQuest.cleanScript()

Debug.Trace("(DSilHand_M70) -- wait 5seconds to finish the quest.")
Utility.Wait(15)
;END CODE
EndFunction
;END FRAGMENT
