...
;BEGIN ALIAS PROPERTY VignarSceneTrigger
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_VignarSceneTrigger Auto
;END ALIAS PROPERTY
...
;BEGIN CODE
; Frag05 is removed from player inventory, a short scene of Fjoll call must run, and all the man must go to Skyforge.
...
; at the end of the scene the stage must be set to 110
;END CODE
EndFunction
;END FRAGMENT
...
DSilHand_M60_SceneAssault.Start()
;END CODE
EndFunction
;END FRAGMENT
...
Debug.Trace("(DSilHand_M80:60) -- start stage 60: temp stage")
...
Debug.Trace("(DSilHand_M80:20) -- start stage 20: Meet the men on the secret passage beneath the Underforge outside of Whiterun and talk with Fjol.")
...
;BEGIN CODE
Debug.Trace("(DSilHand_M80:62) -- start stage62")
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Debug.Trace("(DSilHand_M80:61) -- start stage 61")
;END CODE
EndFunction
;END FRAGMENT
...
Debug.Trace("(DSilHand_M80:10) -- start stage 10: Prepare to assault Jorrvaskr after the dusk.")
...
Scene Property DSilHand_M60_SceneAssault  Auto  
{Scene Object to make the Silver Hands go to Jorrvaskr and Fight the Companions.}
