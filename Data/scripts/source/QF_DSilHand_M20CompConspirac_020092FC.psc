...
Function Fragment_3()
;BEGIN CODE
Debug.Trace("(DSilHand_M40) -- Quest M40 stage 5")
;END CODE
EndFunction
;END FRAGMENT
...
;END AUTOCAST
;BEGIN CODE
Debug.Trace("(DSilHand_M40) -- Quest M40 stage 60")
Debug.Trace("(DSilHand_M40) -- Remove Fragment 07 from inventory")
Game.GetPlayer().RemoveItem(Alias_Frag07.GetReference())
Debug.Trace("(DSilHand_M40) -- Reevalueta AI Packages for Fjol")
...
;
Debug.Trace("(QF_DSilHandM40) -- Quest M40 stage 25")
Debug.Trace("(QF_DSilHandM40) Companions attack! -- 1second of delay")
...
Function Fragment_9()
;BEGIN CODE
Debug.Trace("(DSilHand_M40) -- Quest M40 stage 50")
;END CODE
EndFunction
;END FRAGMENT
...
Function Fragment_0()
;BEGIN CODE
Debug.Trace("(DSilHand_M40) -- Quest M40 Started")
;END CODE
EndFunction
;END FRAGMENT
...
Function Fragment_8()
;BEGIN CODE
Debug.Trace("(DSilHand_M40) -- Quest M40 stage 40")
;END CODE
EndFunction
;END FRAGMENT
...
;
Debug.Trace("QF_DSilHand_M40 -- Evaluate Fjol AI Packages")
Alias_Fjol.GetActorRef().EvaluatePackage()
;END CODE
EndFunction
;END FRAGMENT
...
;END AUTOCAST
;BEGIN CODE
Debug.Trace("(DSilHand_M40) -- Quest M40 stage 30")
;END CODE
EndFunction
;END FRAGMENT
...
;END AUTOCAST
;BEGIN CODE
Debug.Trace("(DSilHand_M40) -- Quest M40 stage 70")
Debug.Trace("(DSilHand_M40) -- move the silverhand from Dustmam's Cairn to Driftshade")
kmyQuest.moveSilverToDriftshade()

Debug.Trace("(DSilHand_M40) -- rewards: Bear Armor")
...
; Init next quest: M50
Debug.Trace("(DSilHand_M40) -- Init M50 -> set stage 5")
...
Function Fragment_5()
;BEGIN CODE
Debug.Trace("(QF_DSilHand_M40) -- Quest M40 stage 20")

;
; Set Fjol as a follower
;
Debug.Trace("(QF_DSilHand_M40)  -- make Fjol a follower");
Actor fjol = Alias_Fjol.GetReference() as Actor
; Fjol will help you
fjol.SetPlayerTeammate()
fjol.SetRelationshipRank(Game.GetPlayer(), 3)
fjol.EvaluatePackage()

;
; Scenario setup: Disable all rubble blocking the passage, and replace the levers and gates
;
Debug.Trace("(QF_DSilHand_M40)  --  Scenario setup: Disable all rubble blocking the passage, and replace the levers and gates");
...
Debug.Trace("(DSilHand_M40) -- Quest M40 stage 10")
Actor fjol = Alias_Fjol.GetReference() as Actor
