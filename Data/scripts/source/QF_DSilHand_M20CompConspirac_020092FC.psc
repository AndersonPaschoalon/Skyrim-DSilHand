...
Debug.MessageBox("-- Companions attack!!!!")
kmyQuest.companionsAttack(0)
;END CODE
EndFunction
;END FRAGMENT
...
;END AUTOCAST
;BEGIN CODE
Debug.Trace("-- Quest M40 stage 60")
Debug.Trace("-- move the silverhand from Dustmam's Cairn to Driftshade")
...
Function Fragment_8()
;BEGIN CODE
Debug.Trace("-- Quest M40 stage 40")
;END CODE
EndFunction
;END FRAGMENT
...
;END AUTOCAST
;BEGIN CODE
Debug.Trace("-- Quest M40 stage 30")
;END CODE
EndFunction
;END FRAGMENT
...
Function Fragment_9()
;BEGIN CODE
Debug.Trace("-- Quest M40 stage 50")
;END CODE
EndFunction
;END FRAGMENT
...
Function Fragment_5()
;BEGIN CODE
Debug.Trace("(QF_DSilHandM40) -- Quest M40 stage 20")
...
Debug.Trace("-- Quest M40 stage 10")
Actor fjol = Alias_Fjol.GetReference() as Actor
