...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;Function disableActor(Actor npc, String actorName)
;    Debug.Trace(THIS_FILE + " -- Disable Actor " + actorName + " <" + npc + ">")
;    if(npc != None)
;        npc.Disable()
;    else
;        Debug.Trace(THIS_FILE + " **ERROR** Reference to actor " + actorName + " is EMPTY!", 2)
;    endif     
;endFunction
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;Function disableObject(ObjectReference obj, String objName)
;    Debug.Trace(THIS_FILE + " -- Disable Actor " + objName + " <" + obj + ">")
;    if(obj != None)
;        obj.Disable()
;    else
;        Debug.Trace(THIS_FILE + " **ERROR** Reference to acotor " + objName + " is EMPTY!", 2)
;    endif   
;endFunction
...
; logs an error message.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;Function disableActorRefAlias(ReferenceAlias npc, String actorName)
;    Debug.Trace(THIS_FILE + " -- Disable Actor " + actorName + " <" + npc + ">")
;    if(npc != None)
;        npc.GetActorReference().Disable()
;    else
;        Debug.Trace(THIS_FILE + " **ERROR** Reference to actor " + actorName + " is EMPTY!", 2)
;    endif     
;endFunction
